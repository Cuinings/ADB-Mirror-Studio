...
- 支持从 `V1.0.0`、`V1.0.1` 和 `V1.1.0` 直接覆盖升级，保留现有本机设置。
- V1.1.0 及更早版本需要手动下载安装 V1.2.0；安装 V1.2.0 后，后续版本可使用应用内下载安装。
...
大小：80113561 字节
SHA256：45852CD3D5310A70737194AB8EB4D25935B15CA2ACCB78123911AAF19FD14F4E

AdbMirrorStudio-V1.2.0-win-x64.zip
大小：117279485 字节
SHA256：E8B440DC9E338BC14BA34753EAA652F38B4D3AD87C72846393D2416DA1BCD89E
```
